...
knitr::include_graphics("../figures/all_dags-two.png")
```
...
Additionally, methods like MR-clust have the potential to reveal additional relationships among genes that share a biological pathway [@foley_mr-clust_2021]. The STROBE-MR statement has additional practice recommendations [@skrivankova_strengthening_2021].
