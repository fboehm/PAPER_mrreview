...
appearance of the early GWAS (Figure \@ref(fig:article-counts)). Inverse variance 
...
ability to use published has led to a rapid increase in the number of available
