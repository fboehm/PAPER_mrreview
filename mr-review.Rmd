...
```{r, dag1, fig.cap = "Scenario where the genetic variant affects an intermediate variable W on the pathway to the exposure X. This violates the exclusion restriction assumption."}
...
Recognition of the many ways that the MR assumptions may be violated has both inspired methods advances that 
enable assumption relaxations under certain conditions and motivated use of sensitivity analysis to quantify the impact of possible assumption violations. 
