...
While we've focused on continuous outcomes and continuous exposures, some
...
binary exposure by drawing on @gauvreau_analysis_1997 and treating the exposure and outcome as correlated binary variables. Writing the likelihood for this model, they implemented an iterative optimization algorithm to simultaneously infer the causal effect parameter and other parameters.
