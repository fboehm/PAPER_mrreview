...
knitr::include_graphics("figures/mr-gwas-counts.png")
```
...
estimates with their many desirable properties [@fisher1925likelihood]. Limited information maximum likelihood from econometrics 
...
```{r, dag1, fig.cap = "Scenario where the genetic variant G affects an intermediate variable W on the pathway to the exposure X. Because W affecs Y through pathways that don't involve exposure X, this scenario violates the exclusion restriction assumption."}
...
and $\tau$ is a vector of independent and identically distributed normal random errors with mean zero.
...
studies. However, this area is relatively unexplored. @hazewinkel_mendelian_2022 treated hospitalizations as a count variable and 
