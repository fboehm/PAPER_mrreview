...
weighting" because each causal SNP's effect is weighted by the inverse of the variance 
...
analysis with hundreds of SNPs, some of which may be invalid instruments by violating one or more of the three core assumptions.

@zhao_statistical_2020 presented MR-RAPS, a method that leverages a robust adjusted profile score to accomplish statistical inference in two-sample MR analyses with GWAS data. 
