...
traits in observational human genetics studies. Throughout the manuscript, we 
use the term "complex trait" to refer to a trait that doesn't appear to be 
inherited in a Mendelian fashion. Typically, traits such as gene expression levels
are inherited in a polygenic manner, with many genes influencing the trait.

Genome-wide association studies (GWAS) present unique opportunities for 
discovery of causal relationships via mendelian randomization. A genome-wide association study 
