...
publication of the early GWAS (Figure \@ref(fig:article-counts)). Many studies use the "two-sample" MR design, in which one cohort of subjects has measurements for the exposure, while a second cohort has measurements for a second trait [@pierce_efficient_2013]. Importantly, the SNP instruments are measured in both sets of subjects.
