...
variable. The LD clumping procedure then selects high ranking SNPs that are not in high LD with each other.
...
the causal effect parameter. Specifically, CAUSE calculates the expected log pointwise posterior density 
...
biased. CAUSE, they found, yields overly conservative p-values.
