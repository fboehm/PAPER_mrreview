...
traits in observational human genetics studies. Discovery of such relationships is crucial to 
...
inferring causal effects of an exposure variable on an outcome variable. They are termed 
"two-sample" MR studies because the exposure variable and the outcome variable are measured on 
two non-overlapping cohorts of subjects. Importantly, the SNPs are measured in both sets of subjects.



Throughout the manuscript, we 
use the term "complex trait" to refer to a trait that doesn't appear to be 
inherited in a Mendelian fashion. Typically, such complex traits, for example, gene expression levels,
