...
is the earliest approach for likelihood-based inference in MR [@davidson1993estimation;@hansen1996finite]. 
...
In efforts to detect the presence of horizontal pleiotropy in two-sample MR studies with GWAS summary data, @greco_m_detecting_2015 developed the between-instrument heterogeneity $Q$ test. In a meta-analysis of MR Wald ratio estimates, one per SNP instrument, they calculate $Q$ in Equation \@ref(eq:q).
...
the outcome of interest [@diprete_genetic_2018]. In constructing polygenic scores from subsets of a GWAS 
cohort, @diprete_genetic_2018 aim to reduce bias due to horizontal pleiotropy. 
