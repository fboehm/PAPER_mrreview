...
of its marginal (univariate) causal effect, and the overall causal effect is the sum of the weighted SNP
causal effects.

Specifically, @burgess_mendelian_2013 combined causal effect (ratio) estimates from multiple independent SNPs by using Equation \@ref(eq:ivw). 
