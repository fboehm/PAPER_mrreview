...
@bowden_consistent_2016 devised a weighted median-based estimator. Its breakdown point is 50\%, 
...
@hartwig_robust_2017 developed a weighted mode-based MR causal effect estimation method. 
...
exposure-increasing alleles for SNP $k$ has an unweighted allele score $z = \sum_{k = 1}^K g_{ik}$ 
