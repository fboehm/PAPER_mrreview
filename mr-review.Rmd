...
in parallel with development of Mendelian randomization methods. We argue that the recent availability of GWAS summary statistics for diverse complex traits has led to new Mendelian randomization methods and that this area continues to offer opportunities for additional methods developments. 
...
likelihood-based methods. A two-stage statistical model involves two regression models [@burgess_review_2017;@sawa_exact_1969]. For a continuous 
...
the approach that uses GWAS summary statistics. Two equations are central to MRAID modeling (Equations \@ref(mraid1) and \@ref(mraid2)).
