...
affect performance. 
CAUSE allows for a proportion of variants to exhibit correlated pleiotropy, which @morrison_mendelian_2020 
models as an effect on a shared, unobserved factor. The remaining variants are independent of this 
unobserved factor. Every variant can have a nonzero pleiotropic effect on the outcome, and these 
...
MR analysis has revealed causal relationships and led to mechanistic insights for many 
