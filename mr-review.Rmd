...
We discuss PMR-Egger below in the context of methods that deal with horizontal pleiotropy. 
...
In the case of continuous exposures and outcomes, we extend the methods and models for 
single-SNP MR to accommodate multiple SNPs. For two stage analyses, we perform 
