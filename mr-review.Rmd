...
\begin{eqnarray}
  \sum_i (y_i - f(y_i;\beta)) = 0\nonumber \\
  \sum_i z_i(y_i - f(y_i;\beta)) = 0
  (\#eq:gmm)
\end{eqnarray}

The GMM estimate is the value of the vector $\beta$ that sastisfies Equation \@ref(eq:gmm), where $f(\mathbb{E}(Y|\text{do}(X = x))$
